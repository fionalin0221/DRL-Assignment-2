...
def safe_pickle_dump(obj, filepath):
    dirpath = os.path.dirname(filepath)
    with tempfile.NamedTemporaryFile('wb', dir=dirpath, delete=False) as tmp_file:
...
final_scores = td_learning(env, approximator, num_episodes=200000, alpha=1, gamma=1, epsilon=0.1)
